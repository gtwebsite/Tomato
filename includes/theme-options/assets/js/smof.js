...
jQuery(document).ready(function($){
	...
	$('#expand_options').click(function(){
		if(flip == 0){
			...
			$('#of_container #main').addClass('fullwidth');
			/*****/
			...
			/***** Updated by Gtwebsite *****/
			$('#of_container #main').removeClass('fullwidth');
			/*****/
	...
	/***** Added by Gtwebsite *****/
	//Add new feedback
	$(".feedback_add_button").live('click', function(){		
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Feedback ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Name</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>Title / Company</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][company]" id="' + sliderId + '_' + newNum + '_slide_company" value=""><label>Photo</label><input class="slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '">Upload</span><span class="button remove-image hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div><label>Feedback</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][description]" id="' + sliderId + '_' + newNum + '_slide_text" cols="8" rows="8"></textarea><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
